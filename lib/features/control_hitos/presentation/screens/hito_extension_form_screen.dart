...
class HitoExtensionFormScreen extends StatefulWidget {
  ...
  @override
  State<HitoExtensionFormScreen> createState() =>
      _HitoExtensionFormScreenState();
}
...
class _HitoExtensionFormScreenState extends State<HitoExtensionFormScreen> {
            ...
            children: [
              ...
              _FormSection(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(
                      child: _InfoCountTile(
                        label: 'Ampliaciones',
                        count: record.extensionCount,
                        color: _D.yellow,
                  ...
                  children: [
                    _DatePickerField(
                      ...
                      onTap: () => _pickDate(
                        initial:
                            _newContractualDate ??
                            record.effectiveContractualDate,
                        onPicked: (d) =>
                            setState(() => _newContractualDate = d),
                        clearable: true,
                        onCleared: () =>
                            setState(() => _newContractualDate = null),
                      ),
                    ),
                    ...
                    if (_newTargetDate != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _D.green.withValues(alpha: 0.25),
                          ),
                        ),
                        child: Row(
                          children: [
              ...
              _FormSection(
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      onTap: (!_saving && canWrite) ? _pickDocument : null,
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _supportDocumentName != null
                              ? _D.accentLight.withValues(alpha: 0.5)
                              : _D.bg,
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                            color: _supportDocumentName != null
                                ? _D.primary.withValues(alpha: 0.4)
                                : _D.stroke,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    _supportDocumentName != null
                                        ? 'PDF, Word o imagen · toca para cambiar'
                                        : 'PDF, Word o imagen (opcional)',
                                    style: const TextStyle(
                                      fontSize: 10,
                                      color: _D.mutedLight,
                                    ),
  ...
  Future<void> _pickDocument() async {
    try {
      ...
      if (!_isAllowed(file.name)) {
        _snack('Selecciona un PDF, Word o imagen.');
        return;
      }
      setState(() {
      ...
      _snack(
        'Cierra y vuelve a abrir la app para habilitar la carga de archivos.',
      );
    }
  }
  ...
  Future<void> _save(
    ...
    if (_newTargetDate == null) {
      _snack('Define la nueva fecha meta.');
      return;
    }
    if (_reasonController.text.trim().isEmpty) {
      _snack('Escribe el motivo de la ampliación.');
      return;
    }
          ...
          Wrap(
            ...
            children: [
              ...
              _Tag(
                ...
                label: record.typeLabel.isNotEmpty ? record.typeLabel : 'Hito',
              ),
            ],
          ),
          const SizedBox(height: 12),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: picked ? color.withValues(alpha: 0.4) : _D.stroke,
            width: picked ? 1.5 : 1,
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: picked ? color.withValues(alpha: 0.12) : _D.stroke,
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: picked ? color : _D.mutedLight,
                    ),
                  ),
                ],
              ),
                ...
                : Row(
                    ...
                    children: [
                      Icon(
                        Icons.save_rounded,
                        size: 18,
                        color: canSave ? _D.white : _D.muted,
                      ),
                      const SizedBox(width: 8),
                      Text(
                        'Guardar ampliación',
