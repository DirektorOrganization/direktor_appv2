...
class _O9AgreementDetailScreenState extends State<O9AgreementDetailScreen> {
  ...
  void initState() {
    ...
    final resolvedGroup =
        widget.groupOptions.where((option) => option.id == widget.groupId).firstOrNull ??
        widget.groupOptions.where((option) => option.name == widget.group).firstOrNull;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      TextField(
                        controller: _dueCtrl,
                        decoration: const InputDecoration(
                          labelText: 'Fecha límite (DD/MM/AAAA)',
          ...
          if (_editing && !isInformative && !widget.readOnly) ...[
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: surface,
