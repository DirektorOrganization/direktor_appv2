              ...
              child: Column(
                ...
                children: [
                  ...
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V2 - Opción 1)',
                    subtitle: 'Propuesta de rediseño 1: Interfaz Clean & Bold',
                    footer: 'Diseño para sector construcción - Datos dummy',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 1',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsRedesignOption1),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V2 - Opción 2)',
                    subtitle: 'Propuesta de rediseño 2: Interfaz Analítica',
                    footer: 'Diseño con resumen global - Datos dummy',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 2',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsRedesignOption2),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V2 - Opción 3)',
                    subtitle: 'Enfoque Field-First: Interacciones en Obra',
                    footer: 'Tarjetas grandes, alto contraste, modales',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 3',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsRedesignOption3),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V2 - Opción 4)',
                    subtitle: 'Enfoque Proceso / Línea de Tiempo',
                    footer: 'Seguimiento Kanban y fases',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 4',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsRedesignOption4),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V2 - Opción 5)',
                    subtitle: 'Enfoque Centro de Mando / Tablet',
                    footer: 'Pantalla dividida, alta densidad de datos',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 5',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsRedesignOption5),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V3 - Opción 6)',
                    subtitle: 'Obra Viva: Categoría → Subcategoría → Sesión',
                    footer: 'Flujo de obra, asistencia, cierre y PDF',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 6',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsOption6),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    ...
                    title: 'Actas de reuniones (V3 - Opción 7)',
                    subtitle: 'Acuerdos Primero: Tracker + Timeline de sesiones',
                    footer: 'Kanban de acuerdos, comentarios y debate',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 7',
                    onPrimaryPressed: () => Navigator.pushNamed(context, RouteNames.meetingsOption7),
                  ),
                  const SizedBox(height: 14),
                  _ModuleSummaryCard(
                    icon: Icons.dashboard_rounded,
                    iconColor: const Color(0xFF0A3D62),
                    accentColor: const Color(0xFF0A3D62),
                    title: 'Actas de reuniones (V3 - Opción 8)',
                    subtitle: 'Panel Ejecutivo: KPIs + Alertas + Análisis',
                    footer: 'Dashboard, sesión activa, acta digital con PDF',
                    indicators: const [],
                    primaryLabel: 'Ver Opción 8',
